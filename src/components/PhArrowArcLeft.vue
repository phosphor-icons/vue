...
<template>
  ...
  <polyline points="92.118 148.118 28.118 148.118 28.118 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  <path d="M224,184A96,96,0,0,0,60.11775,116.11775l-32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
</g>
    <g v-else-if="displayWeight === 'duotone'">
  <polyline points="92.118 148.118 28.118 148.118 28.118 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <path d="M224,184A96,96,0,0,0,60.11775,116.11775l-32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
</g>
  ...
  <polyline points="92.118 148.118 28.118 148.118 28.118 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  <path d="M224,184A96,96,0,0,0,60.11775,116.11775l-32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
</g>
    <g v-else-if="displayWeight === 'thin'">
  <polyline points="92.118 148.118 28.118 148.118 28.118 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  <path d="M224,184A96,96,0,0,0,60.11775,116.11775l-32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
</g>
