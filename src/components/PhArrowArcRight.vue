...
<template>
  ...
  <polyline points="163.882 148.118 227.882 148.118 227.882 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  <path d="M32,184a96,96,0,0,1,163.88225-67.88229l32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
</g>
    <g v-else-if="displayWeight === 'duotone'">
  
  <polyline points="163.882 148.118 227.882 148.118 227.882 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  <path d="M32,184a96,96,0,0,1,163.88225-67.88229l32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
</g>
  ...
  <polyline points="163.882 148.118 227.882 148.118 227.882 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  <path d="M32,184a96,96,0,0,1,163.88225-67.88229l32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
</g>
    <g v-else-if="displayWeight === 'thin'">
  
  <polyline points="163.882 148.118 227.882 148.118 227.882 84.118" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
  <path d="M32,184a96,96,0,0,1,163.88225-67.88229l32,32" fill="none" :stroke="displayColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
</g>
